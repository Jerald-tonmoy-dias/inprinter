...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    return (
        <>
            <Head title="Inpainting with Stable Diffusion &amp; Replicate" />

            <div className="max-w-[512px] mx-auto p-10 bg-white rounded-lg">

                {/* <h1 className="text-center text-7xl pb-3">🎨</h1> */}
                <p className="pb-5 text-lg">
                    <strong>Inpainting</strong> is a process where missing parts
                    of an artwork are filled in to present a complete image.
                    This{" "}
                    <a
                        className="underline"
